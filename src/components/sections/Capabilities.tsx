      ...
      <div className="section-shell relative z-10">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 h-auto md:h-[1000px]">
          ...
          >
            ...
            <p className="text-xs text-zinc-500 font-mono uppercase tracking-widest">Configurations</p>
          ...
          >
            <div className="scanner-line" />
            <p className="text-[10px] font-mono text-cyan-500 uppercase tracking-widest mb-4">Signal</p>
            ...
            <p className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest mt-1">Excellent</p>
          </TacticalFrame>
          ...
          >
            ...
            <div className="flex justify-between items-center h-full">
              <div>
                <p className="text-[10px] font-mono text-orange-500 uppercase tracking-widest mb-3">Targeting</p>
                <h3 className="text-2xl font-light text-white">Threat Detection</h3>
                <p className="mt-3 text-xs text-zinc-500 font-light max-w-xs leading-relaxed">
                  Real-time pattern matching for non-standard aerial signatures and electronic interference.
                </p>
              </div>
          ...
          >
            <div className="scanner-line" />
            <p className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest mb-4">Encryption</p>
          ...
          >
            <div className="scanner-line" />
            <p className="text-[10px] font-mono text-emerald-500 uppercase tracking-widest mb-4">Fleet Health</p>
